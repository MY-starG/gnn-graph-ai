...
if __name__ == "__main__":
    ...
    scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer, mode='max', factor=0.5, patience=20)  # FIXED: Removed verbose
    ...
    # Save the best model
    save_path = os.path.join(save_dir, 'gat_best.pth')
